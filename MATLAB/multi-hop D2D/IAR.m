...
function [distance path] = IAR(Delay,Dth,D2DUE_Distance,tx,rx,D2DUE)
...
if tx == ex1
    ...
    [distance1 path1] = CD(Delay,Dth,tx,ex1,D2DUE);
end
...
if ex1 == ex2                                                                  %若ex1和ex2是同一用户，则IAR算法的第二步省略
    ...
    [distance2 path2] = CD(Delay,Dth,ex1,ex2,D2DUE);
end
...
if ex2 == rx
    ...
    [distance3 path3] = CD(Delay,Dth,ex2,rx,D2DUE);
end
